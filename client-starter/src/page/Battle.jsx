    ...
    useEffect(() =>{
      const getPlayerInfo = async () => {
        try {
          ...
          if(gameData.activeBattle.player[0].toLowerCase() === walletAddress.toLowerCase()){
            player01Adress = gameData.activeBattle.players[0]
            player02Adress = gameData.activeBattle.players[1]
          }else{
            player01Adress = gameData.activeBattle.players[1]
            player02Adress = gameData.activeBattle.players[0]
          }
